...
export function AnimatedAIChat() {
    ...
    return (
        <div className="w-full flex flex-col items-center justify-center bg-transparent text-white p-6 relative overflow-hidden">
            <div className="w-full max-w-2xl mx-auto relative content-container">
                <motion.div 
