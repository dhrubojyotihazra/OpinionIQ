    ...
    <div className="flex justify-center items-center w-full">
      <motion.button
        ...
        className={`relative flex items-center border-2 rounded-full overflow-hidden transition-all
          ${isDownloading ? 'cursor-wait border-blue-500' : 'cursor-pointer border-indigo-500 hover:border-indigo-400'}`}
        animate={{
      ...
      >
        ...
        <motion.div
          className="h-14 w-14 rounded-full bg-indigo-500 flex justify-center items-center relative shadow-lg z-10"
        ...
        >
          {/* Progress fill */}
          <motion.div
            className="absolute top-0 left-0 w-full bg-indigo-800 rounded-full"
            initial={{ height: '0%' }}
